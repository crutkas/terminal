...
namespace Microsoft::Console::Render::Atlas
{
    ...
    public:
        ...
        [[nodiscard]] HRESULT PaintImageSlice(const ImageSlice& imageSlice, ImageSlice::RenderPosition position, til::CoordType targetRow, til::CoordType viewportLeft, std::span<const uint8_t> backgroundMask) noexcept override;
