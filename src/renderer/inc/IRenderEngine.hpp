...
#pragma warning(suppress : 26432) // If you define or delete any default operation in the type '...', define or delete them all (c.21).
        ...
        [[nodiscard]] virtual HRESULT BeginImageSliceRow() noexcept = 0;
        [[nodiscard]] virtual HRESULT PaintImageSlice(const ImageSlice& imageSlice, ImageSlice::RenderPosition position, til::CoordType targetRow, til::CoordType viewportLeft, std::span<const uint8_t> backgroundMask) noexcept = 0;
        [[nodiscard]] virtual HRESULT EndImageSliceRow() noexcept = 0;
