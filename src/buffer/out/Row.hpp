...
// Resolved coordinates for a Kitty Unicode image placeholder. This is stored with
...
public:
    ...
    const KittyPlaceholderCell* GetKittyPlaceholderCell(til::CoordType column) const noexcept;
    void SetKittyPlaceholderCell(til::CoordType column, const KittyPlaceholderCell& metadata);
    void CopyKittyPlaceholderCells(const ROW& source, til::CoordType sourceColumnBegin, til::CoordType columnBegin, til::CoordType columnEnd);
...
private:
    ...
    void _clearKittyPlaceholderCells(til::CoordType columnBegin, til::CoordType columnEnd) noexcept;
    ...
    // Allocated lazily only for rows containing Kitty Unicode placeholders.
    std::vector<KittyPlaceholderCell> _kittyPlaceholderCells;
};
