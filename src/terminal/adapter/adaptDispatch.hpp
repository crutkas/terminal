...
namespace Microsoft::Console::VirtualTerminal
{
    ...
    private:
        ...
        til::size _placeKittyImage(const KittyImage& image, bool moveCursor, uint32_t imageId, uint64_t layerId, uint32_t cols = 0, uint32_t rows = 0, uint32_t srcX = 0, uint32_t srcY = 0, uint32_t srcW = 0, uint32_t srcH = 0, int32_t zIndex = 0, std::optional<til::point> anchor = std::nullopt);
